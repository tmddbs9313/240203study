...
public class Application03 {
    public static void main(String[] args) {
        ...
        *  지금까지 우리가 배운 변수는 지역변수에 헤당한다.*/

        /*필기.
        *  지역변수는 선언한 메소드 블럭 내부에서만 사용이 가능하다. 이것을 지역변수의 스코프라고 한다.
        *  다른 메소드 간 서로 공유해야하는 값이 존재하는 경우 메소드 호출시 사용하는 괄호를 이용해서 값을 전달할 수 있다.
        ...
        *  메소드 선언부 괄호 안에 전달 인자를 받기 위해 선언하는 변수를 매개변수(parameter)라고 부른다.*/
        ...
        /*목차. 1. 전달인자로 값 전달 테스트*/
        app3.testMethod( 22);
//        app3.testMethod ("20");  // 밑에꺼 public void testMethod(String age){ 으로 바꿀시만 ㄱㄴ
