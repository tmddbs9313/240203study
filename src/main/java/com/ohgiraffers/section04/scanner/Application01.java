...
//        java.util.Scanner sc= new java.util.Scanner(System.in);
        ...
        String name = sc.nextLine();   // nectline 값을 name 이라는 변수에 저장해줌.
        System.out.println("입력하신 이름은 " + name + "입니다.");

        /*목차. 2-1. 정수값 입력받기.*/
        /*필기. nextint() : int형 으로 반환*/
        System.out.print("나이를 입력해주세요 : ");
        int age = sc.nextInt();
        System.out.println("입력하신 나이는 " +age+ "입니다");

        /*필기. nextLong() : 입력받은 값을 long 형으로 반환.*/
        System.out.print("금액을 입력해주세요 : ");
        long money = sc.nextLong();
        System.out.println("입력하신 금액은 " +money+ "원 입니다");

        /*필기. nextFloat() :입력받은 값읆 float 형으로 반환한다.*/
        System.out.print("키를 입력해주세요 : ");
        float height = sc.nextFloat();
        System.out.println("입력하신 키는 "+height+"입니다");

        /*필기. nextDouble() : 입력받은 값을 double 형으로 반환한다.*/
        System.out.print("원하시는 실수를 입력하세요 : ");
